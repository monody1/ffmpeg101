...
// static const char* inputPath = "/Users/chen.zr/workspace/ffmpeg101/demo.mp4";
// static const char* outputPath = "/Users/chen.zr/workspace/ffmpeg101/demohevc.mp4";
static char* videoEncoderName;
static char* audioEncoderName;
...
static int open_output_file(const char *filename)
{
    ...
    for (i = 0; i < ifmt_ctx->nb_streams; i++) {
        ...
        if (dec_ctx->codec_type == AVMEDIA_TYPE_VIDEO){
            ...
            encoder = avcodec_find_encoder_by_name(videoEncoderName);
            if (!encoder) {
            ...
            encoder = avcodec_find_encoder_by_name(audioEncoderName);
            if (!encoder) {
...
int main(int argc, char **argv)
{
    ...
    videoEncoderName = argv[3];
    audioEncoderName = argv[4];
